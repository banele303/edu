...
import { Plus, FileText, Clock, Users, Loader2, Zap, GraduationCap, BookOpen, Trophy, RotateCcw } from "lucide-react";
...
const Exams = () => {
  ...
  const [activeTab, setActiveTab] = useState<"all" | "quiz" | "exam">("all");
