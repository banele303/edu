...
const perks = [
  ...
  { icon: Sparkles, text: "New EduNexus feature releases" },
];
...
const Newsletter = () => {
  ...
  return (
    <section id="newsletter" className="py-28 relative overflow-hidden">
      ...
      {/* Glow orbs */}
      <div className="absolute top-0 left-1/4 w-[500px] h-[500px] bg-[#3ecf8e]/10 blur-[160px] rounded-full pointer-events-none" />
      <div className="absolute bottom-0 right-1/4 w-[500px] h-[500px] bg-[#3ecf8e]/5 blur-[160px] rounded-full pointer-events-none" />
      {/* Dot grid overlay */}
      <div
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center space-y-6">
          ...
          <div className="flex justify-center">
            <div className="w-16 h-16 rounded-2xl bg-[#3ecf8e]/20 border border-[#3ecf8e]/30 flex items-center justify-center">
          ...
          {/* Heading */}
          <div>
            <p className="text-[#3ecf8e] text-xs font-bold uppercase tracking-widest mb-3">
              Stay Informed
            </p>
            <h2 className="text-4xl md:text-5xl font-extrabold text-white leading-tight">
              The South African{" "}
              <span className="text-[#3ecf8e]">Education Digest</span>
            </h2>
            ...
            {perks.map((perk, idx) => (
              <div key={idx} className="flex items-center gap-2 text-gray-300 text-sm">
                <div className="w-7 h-7 rounded-lg bg-[#3ecf8e]/10 border border-[#3ecf8e]/20 flex items-center justify-center shrink-0">
                  <perk.icon className="w-3.5 h-3.5 text-[#3ecf8e]" />
                </div>
                {perk.text}
              </div>
            ))}
            ...
            {!submitted ? (
              <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3">
                <input
                  ...
                  required
                  className="flex-1 bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl px-5 py-4 text-white placeholder-gray-500 focus:outline-none focus:border-[#3ecf8e]/60 focus:bg-white/10 transition-all text-sm"
                />
                <button
                  type="submit"
                  className="bg-[#3ecf8e] text-black px-7 py-4 rounded-xl font-bold text-sm hover:bg-[#34b27b] transition-all hover:scale-105 shadow-xl shadow-[#3ecf8e]/20 shrink-0"
                >
                  Subscribe Free
                </button>
              </form>
              ...
              <div className="flex flex-col items-center gap-3 py-4 animate-pulse-once">
                <div className="w-14 h-14 rounded-full bg-[#3ecf8e]/20 border border-[#3ecf8e]/40 flex items-center justify-center">
