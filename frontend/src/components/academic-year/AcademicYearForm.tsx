...
const AcademicYearForm = ({
  ...
  const createYearMutation = useMutation(api.academicYears.createYear);
  const updateYearMutation = useMutation(api.academicYears.updateYear);
  ...
  const onSubmit = async (data: FormValues) => {
    try {
      if (initialData) {
        await updateYearMutation({
          id: initialData._id as any,
          name: data.name,
          fromYear: data.fromYear.toISOString(),
          toYear: data.toYear.toISOString(),
          isCurrent: data.isCurrent,
        });
        toast.success("Academic year updated");
      } else {
        await createYearMutation({
          name: data.name,
          fromYear: data.fromYear.toISOString(),
          toYear: data.toYear.toISOString(),
          isCurrent: data.isCurrent,
