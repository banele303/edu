...
const About = () => {
  ...
  return (
    <div>
      ...
      <main>
        {/* Hero */}
        <section className="relative pt-32 pb-24 bg-gradient-to-b from-[#3ecf8e]/10 to-background overflow-hidden">
          <div className="absolute top-20 left-10 w-72 h-72 bg-[#3ecf8e]/10 rounded-full blur-[120px]" />
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-3xl">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-400 leading-relaxed">
                EduNexus was born from a simple observation: South African educators spend
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400 text-lg leading-relaxed mb-6">
                  From township schools in Limpopo to private academies in Cape Town, EduNexus
                  serves over 200 schools across all nine provinces, managing more than 150,000
                  learner records.
                </p>
                <div className="flex gap-8">
                  <div>
                    <p className="text-4xl font-bold text-[#3ecf8e]">200+</p>
                    <p className="text-sm text-gray-500">Schools</p>
                  </div>
                  <div>
                    <p className="text-4xl font-bold text-[#3ecf8e]">150K</p>
                    <p className="text-sm text-gray-500">Learners</p>
                  </div>
                  <div>
                    <p className="text-4xl font-bold text-[#3ecf8e]">9</p>
              ...
              <div className="grid grid-cols-2 gap-4">
                {values.map(({ icon: Icon, title, desc }) => (
                  <div key={title} className="bg-gray-50 dark:bg-[#1c1c1c] rounded-2xl p-6 border border-gray-200 dark:border-gray-800">
                    <div className="bg-[#3ecf8e]/10 w-12 h-12 rounded-xl flex items-center justify-center mb-4">
              ...
              {team.map((member) => (
                <div key={member.name} className="text-center">
                  <img
                    src={member.img}
                    alt={member.name}
                    className="w-28 h-28 rounded-full mx-auto mb-4 object-cover border-4 border-[#3ecf8e]/20"
                  />
                  <h3 className="font-bold text-gray-900 dark:text-white">{member.name}</h3>
                  <p className="text-sm text-[#3ecf8e]">{member.role}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="py-20 bg-gray-50 dark:bg-[#1c1c1c]">
          <div className="max-w-4xl mx-auto px-4 text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-6">
              Ready to join the EduNexus family?
            </h2>
