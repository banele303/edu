...
const schema = z.object({
  ...
  questionType: z.enum(["MCQ", "SHORT_ANSWER", "MIXED"]),
});
...
const ExamGenerator = ({ open, onOpenChange, onSuccess }: Props) => {
  ...
  const onSubmit = async (values: FormValues) => {
    try {
      ...
      // Trigger AI Generation (Convex Action)
        ...
        <form onSubmit={form.handleSubmit(onSubmit)}>
          <FieldGroup className="space-y-4">
            ...
            <Controller
              ...
              render={({ field }) => (
                <Field>
                  <FieldLabel>Assessment Format / Question Style</FieldLabel>
                  <Select onValueChange={field.onChange} value={field.value}>
                    <SelectTrigger>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="SHORT_ANSWER">Written Short Answer & Essay</SelectItem>
                      <SelectItem value="MIXED">Mixed Balanced Format (MCQ & Short Answer)</SelectItem>
                    </SelectContent>
                  </Select>
                </Field>
              )}
